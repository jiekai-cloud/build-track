...
已為您準備好最新的更新部署檔案（版本 V4.1 - 報價單備註編輯）：
- **檔案名稱**：`build-track-update-v4-notes.zip`
- **新增功能**：
  1. **可編輯備註**：從「標準庫選擇」的備註文字現在可以自由修改了（例如：修改保固年限或期限）。
  2. **複製工項**：每個工項右側新增「複製」按鈕，可快速複製項目。
  3. **V3功能**：包含刪除大項、編輯編號等修復。
