...
已為您準備好最新的更新部署檔案（版本 V4.2 - 報價單排版優化）：
- **檔案名稱**：`build-track-update-v4.2-pdf-header.zip`
- **新增功能**：
  1. **報價單頁首調整**：縮小了公司名稱的字體大小，並將其與 Logo 一起移至左上角，整體排版更專業簡潔。 (QUOTATION 字樣移至右上)
  2. **可編輯備註**（V4.1）：標準庫備註可自由編輯。
  3. **工項複製**（V4.0）：支援快速複製工項。
