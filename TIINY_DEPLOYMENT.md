...
已為您準備好最新的更新部署檔案（版本 V4.28 - 遠端簽署雲端連動修正）：
- **檔案名稱**：`build-track-update-v4.28-contract-signing.zip`
- **體驗優化**：
  1. **騎縫章顯示修復**：修正了騎縫章可能被邊界裁切而導致無法看見的問題。現在將位置向內微調（5mm），確保無論何種檢視器都能清楚顯示。
...
2. 選擇 `build-track-update-v4.28-contract-signing.zip`
3. 等待上傳完成（約 1-2 分鐘）
