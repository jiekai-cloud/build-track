                ...
                <div className="text-xs space-y-2 text-stone-700">
                    ...
                    <div className="mt-4 p-3 bg-stone-50 rounded border border-stone-200 inline-block w-full">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                            <div>銀行: {quotation.terms?.bankAccount?.bankName || '玉山銀行(808) 士林分行'}</div>
                            <div>戶名: {quotation.terms?.bankAccount?.accountName || '台灣生活品質發展股份有限公司'}</div>
                            <div className="col-span-2 font-mono text-sm mt-1">帳號: {quotation.terms?.bankAccount?.accountNumber || '0657-940-151307'}</div>
                        </div>
                    </div>
                </div>
            </div>
