  ...
  return (
    <div className="flex flex-col lg:h-full animate-in slide-in-from-right-4 duration-500 lg:overflow-hidden">
      ...
      <div className="p-4 lg:p-8 space-y-4 shrink-0 bg-white/50 border-b border-stone-100">
        ...
        {/* 專案角色與介紹資訊 */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-5 bg-stone-50 rounded-[2rem] border border-stone-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center border border-stone-200 shadow-sm">
              <UserIcon size={20} className="text-blue-500" />
            </div>
            <div>
              <p className="text-[9px] font-black text-stone-400 uppercase tracking-widest">報價負責人</p>
              <p className="text-sm font-black text-slate-900">{project.quotationManager || project.manager || '未指定'}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center border border-stone-200 shadow-sm">
            ...
            <div>
              <p className="text-[9px] font-black text-stone-400 uppercase tracking-widest">工程負責人</p>
              <p className="text-sm font-black text-slate-900">{project.engineeringManager || '未指定'}</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center border border-stone-200 shadow-sm">
            ...
            <div>
              <p className="text-[9px] font-black text-stone-400 uppercase tracking-widest">介紹人 / 介紹費</p>
              <p className="text-sm font-black text-slate-900 truncate">
                {project.introducer || '無'}
                {project.introducerFeeRequired && (
                  <span className="ml-2 text-[10px] bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full ring-1 ring-emerald-200">
                    ${project.introducerFeeAmount?.toLocaleString()}
                  </span>
                )}
              </p>
            </div>
