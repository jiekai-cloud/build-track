    ...
    <aside className="h-full w-full bg-stone-900 text-white flex flex-col shadow-2xl">
      ...
      <div className="px-4 py-4 border-t border-stone-800 shrink-0 bg-stone-900/50 backdrop-blur-sm">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-stone-500 hover:bg-stone-800 hover:text-white transition-colors group"
          title="立即同步 (Sync Now)"
        >
          ...
          <span className="font-bold text-xs">立即同步</span>
        </button>
